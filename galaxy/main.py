...
class MainWidget(RelativeLayout):
    ...
    V_NB_LINES=4
    V_LINES_SPACING=.4 #percentage
    vertical_lines=[]

    H_NB_LINES=15
    H_LINES_SPACING=.1 #percentage
    horizontal_lines=[]
    ...
    def init_audio(self):
        ...
        self.sound_begin.volume=.01
        self.sound_galaxy.volume=.01
        self.sound_gameover_impact.volume=.05
        self.sound_gameover_voice.volume=.05
        self.sound_music1.volume=.1
        self.sound_restart.volume=.01
